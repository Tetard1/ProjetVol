...
if(isset($_GET['id'])){
    ...
    $id=null;
    header("Location:afficherPilotes.php");
}
$pilotes=new Pilotes([
    'idPilotes'=>$id
]);
$pilotesRepo=new PilotesRepo();
$resultat= $pilotesRepo->afficherLePilotes($pilotes);
?>
...
<div class="container">
            <div class="top-section">
                <h2>Modifications de la pilotes</h2>
            </div>
        <form action="../src/traitement/modifPilotesTraitement.php" method="POST">
            <table>
                <thead>
                <tr>
                    <th>nom du Pilotes</th>
                    <th>prenom du pilote</th>
                    <th>modifier</th>
                    <input type="hidden" name="idPilotes" value="<?= $id ?>">
                </tr>
                </thead>
                <tbody>
                <tr>
                    <td>
                            <label for="nomPilotes" class="form-label"></label>
                            <input type='text' id="nomPilotes" name='nomPilotes' value="<?=$resultat["nomPilotes"]?>">
                    </td>
                    <td>
                            <label for="prenomPilotes" class="form-label"></label>
                            <input type='text' id="prenomPilotes" name='prenomPilotes' value="<?=$resultat["prenomPilotes"]?>">
                    </td>
                    <td>
