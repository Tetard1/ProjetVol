...
$volRepo = new volRepo();
$resultat = $volRepo->afficherLesVols();
?>
...
<input type="text" id="search" class="search-bar" onkeyup="filtrerVol()" placeholder="Rechercher un vol">
...
<table>
    ...
    <?php foreach ($resultat as $vol): ?>
        <tr>
            ...
            <td><?= $vol["nb_place_dispo"] ?></td>
            <td><?= $vol["prix"] ?></td>
            <td><?= $vol["ref_avions"] ?></td>
            <td><?= $vol["ref_pilotes"] ?></td>
            <td><a href='modifVol.php?id=<?= $vol["id_vol"] ?>'><button type='button' class='btn btn-warning'>Modifier</button></a></td>
            <td><button type='button' class='btn btn-danger' onclick="confirmDelete(<?= $vol['id_vol'] ?>)">Supprimer</button></td>
        </tr>
    <?php endforeach; ?>
    </tbody>
</table>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <form id="confirmDeleteForm" method="post" action="../src/traitement/suppresionVolTraitement.php">
                        <input type="hidden" name="idVol" id="deleteIdInput">
