...
?>
    ...
    <head>
        ...
        <title>Patapouf Airport - Ajout des Avions</title>
            ...
            <div class="row">
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <ul class="nav">
                            <li class="submenu">
                                <a href="javascript:">Liste Avions</a>
                                <ul>
                                    <li><a href="inscription.html">Ajout des avions</a></li>
                                    <li><a href="connexion.php">liste des avions</a></li>
                                </ul>
                            </li>
                        </ul>
            ...
            <div class="row justify-content-center">
                <div class="col-md-6">
                    <div class="card shadow-lg">
                        <div class="card-body">
                            <h3 class="text-center mb-4">Ajout Des Avions</h3>
                            <form action="../src/traitement/ajoutAvionsTraitement.php" method="post">
                                <div class="form-group mb-3">
                                    <label for="nomAvions">Nom de l'avion</label>
                                    <input type="text" class="form-control" id="nomAvions" name="nomAvions" required>
                                </div>
                                <div class="form-group mb-3">
                                    <label for="placeTotale">Place Totale</label>
                                    <input type="number" class="form-control" id="placeTotale" name="placeTotale" required>
                                </div>
